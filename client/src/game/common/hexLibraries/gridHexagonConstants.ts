...
export class GridHexagonConstants {
  ...
  static hexagonDepthLeftPolygon(depthHeight: number) {
    return [
      ...
      new Point(-GridHexagonConstants.width / 2, depthHeight),
      new Point(-GridHexagonConstants.width / 2, 0),
    ];
  }
  ...
  static hexagonDepthRightPolygon(depthHeight: number) {
    return [
      ...
      new Point(GridHexagonConstants.width / 2, 0),
      new Point(GridHexagonConstants.width / 2, depthHeight),
      new Point(GridHexagonConstants.width / 4, depthHeight + GridHexagonConstants.height() / 2),
      new Point(GridHexagonConstants.width / 4, GridHexagonConstants.height() / 2),
    ];
  }
